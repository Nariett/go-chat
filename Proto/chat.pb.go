...
var file_chat_proto_rawDesc = []byte{
	...
	,
...
var file_chat_proto_depIdxs = []int32{
	...
	9,  // 9: chat.ChatService.GetUsers:input_type -> chat.Empty
	9,  // 10: chat.ChatService.GetActiveUsers:input_type -> chat.Empty
	9,  // 11: chat.ChatService.GetUsersActivityDates:input_type -> chat.Empty
	0,  // 12: chat.ChatService.GetUnreadMessagesCounter:input_type -> chat.UserId
	4,  // 13: chat.ChatService.GetUnreadMessagesFromUser:input_type -> chat.UnreadChat
	1,  // 14: chat.ChatService.GetUserId:input_type -> chat.User
	8,  // 15: chat.ChatService.SendMessage:input_type -> chat.UserMessage
	...
	3,  // 23: chat.ChatService.GetUsers:output_type -> chat.Users
	3,  // 24: chat.ChatService.GetActiveUsers:output_type -> chat.Users
	6,  // 25: chat.ChatService.GetUsersActivityDates:output_type -> chat.UserActivityDates
	5,  // 26: chat.ChatService.GetUnreadMessagesCounter:output_type -> chat.UnreadMessages
	9,  // 27: chat.ChatService.GetUnreadMessagesFromUser:output_type -> chat.Empty
	0,  // 28: chat.ChatService.GetUserId:output_type -> chat.UserId
	9,  // 29: chat.ChatService.SendMessage:output_type -> chat.Empty
